 ...
 */
 class Fish extends Animal {
    ...
    soundOff(): string {
        return `The ${this.name} is a fish does that not make sounds.`;
    };
    habitat(): string{
        return `The ${this.name} is a ${saltwater ? "saltwater" : "freshwater"} fish.`
    }
}
 /**
...
class Birds extends Animal {
    ...
    fly(): string {
        ...
        return `The ${this.name} flies at speeds up of to ${this.flightSpeed} meters per second!`
